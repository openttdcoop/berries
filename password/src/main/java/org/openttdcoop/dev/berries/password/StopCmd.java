 ...
 */
@Rename("stop")
public class StopCmd implements GrapeCommand
{
    private PasswordPlugin password;
    
    public StopCmd (PasswordPlugin password)
    {
    ...
    {
        this.password.task.cancel(false);
        cc.reply("Password rotation task stopped.");
    }
